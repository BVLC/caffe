...
var engine = require('engine.io-pure');
var client = require('socket.io-client-pure');
...
var clientSource = read(require.resolve('socket.io-client-pure/socket.io.js'), 'utf-8');
