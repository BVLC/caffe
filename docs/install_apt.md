...
**BLAS**: install ATLAS by `sudo apt-get install libatlas-base-dev` or install OpenBLAS (with `sudo apt-get install libopenblas-dev`) or MKL for better CPU performance.
