...
[![Travis Build Status](https://travis-ci.org/Microsoft/caffe.svg?branch=bvlc_win)](https://travis-ci.org/Microsoft/caffe) Travis (Linux build)

[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/58wvckt0rcqtwnr5/branch/bvlc_win?svg=true)] (https://ci.appveyor.com/project/pavlejosipovic/caffe-3a30a) AppVeyor (Windows build)
