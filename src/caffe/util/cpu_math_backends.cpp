...
template<typename Dtype>
void CPUMathBackend<Dtype>::axpby(const int N, const Dtype alpha,
                                  const Dtype* X, const Dtype beta, Dtype* Y) {
...
template<typename Dtype>
void CPUMathBackend<Dtype>::add_scalar(const int N, const Dtype alpha,
                                       Dtype *X) {
...
template<typename Dtype>
void CPUMathBackend<Dtype>::rng_uniform(const int N, const Dtype a,
...
template<typename Dtype>
void CPUMathBackend<Dtype>::scale(const int N, const Dtype alpha,
