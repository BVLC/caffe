      ...
      for (int h2 = 0; h2 < height2; ++h2) {
        ...
        for (int w2 = 0; w2 < width2; ++w2) {
          ...
          if (packed) {
            ...
            const Dtype* pos2 = &data2[channels * ((y2 + h2) * Width2 + (x2 + w2))];
            for (int c = 0; c < channels; ++c) {
              // we replace weighted formulation by sticking weights to 0 or 1
              // instead of *, we do the tests
              if (h0lambda > h1lambda)
                if (w0lambda > w1lambda)
                  pos1[0] = pos2[0];
                else
                  pos1[channels * w1p] +=  pos2[0];
              else
                if (w0lambda > w1lambda)
                  pos1[channels * h1p * Width1] +=  pos2[0];
                else
                  pos1[channels * (h1p * Width1 + w1p)] +=  pos2[0];
              pos1++;
              pos2++;
            }
          }
            ...
            for (int c = 0; c < channels; ++c) {
              ...
              if (h0lambda > h1lambda)
                ...
                if (w0lambda > w1lambda)
                  pos1[h1p * Width1] += pos2[0];
                else
                  pos1[h1p * Width1 + w1p] += pos2[0];
              pos1 += Width1 * Height1;
              pos2 += Width2 * Height2;
            }
          }
...
// Explicit instances
  template void caffe_cpu_interp2<float,false>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, const bool nn);
  template void caffe_cpu_interp2<float,true>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, const bool nn);
  template void caffe_cpu_interp2<double,false>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, const bool nn);
  template void caffe_cpu_interp2<double,true>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, const bool nn);

  template void caffe_cpu_interp2_backward<float,false>(const int, float *, const int, const int, const int, const int, const int, const int, const float *, const int, const int, const int, const int, const int, const int, const bool nn);
  template void caffe_cpu_interp2_backward<double,false>(const int, double *, const int, const int, const int, const int, const int, const int, const double *, const int, const int, const int, const int, const int, const int, const bool nn);
