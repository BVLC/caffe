...
template<>
DataType proto_data_type<half_fp>() {
  return HALF;
}
template<>
DataType proto_data_type<float>() {
  return FLOAT;
}
template<>
DataType proto_data_type<double>() {
  return DOUBLE;
}
template<>
DataType proto_data_type<int8_t>() {
  return INT8_QUANTIZED;
}
template<>
DataType proto_data_type<int16_t>() {
  return INT16_QUANTIZED;
}
template<>
DataType proto_data_type<int32_t>() {
  return INT32_QUANTIZED;
}
template<>
DataType proto_data_type<int64_t>() {
