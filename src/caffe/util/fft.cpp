...
template <>
void* caffe_fft_malloc<float>(int n) {
  return (reinterpret_cast<void *>(fftwf_malloc(n)));
}
template <>
void* caffe_fft_malloc<double>(int n) {
  return (reinterpret_cast<void *>(fftw_malloc(n)));
}

template <>
void caffe_fft_free<float>(void * p) {
  fftwf_free(p);
}
template <>
void caffe_fft_free<double>(void * p) {
  fftw_free(p);
}

template <>
void* caffe_fft_plan_dft_r2c_2d<float>(int n0, int n1,
...
template <>
void* caffe_fft_plan_dft_r2c_2d<double>(int n0, int n1,
...
template <>
void* caffe_fft_plan_dft_c2r_2d<float>(int n0, int n1,
...
template <>
void* caffe_fft_plan_dft_c2r_2d<double>(int n0, int n1,
...
template <>
void* caffe_fft_plan_many_dft_r2c<float>(int rank, const int *n,
...
template <>
void* caffe_fft_plan_many_dft_r2c<double>(int rank, const int *n,
