...
template<typename Dtype>
void GPUMathBackend<Dtype>::axpby(const int N, const Dtype alpha,
                                  const Dtype* X, const Dtype beta, Dtype* Y) {
...
template<typename Dtype>
void GPUMathBackend<Dtype>::add_scalar(const int N, const Dtype alpha,
                                       Dtype *X) {
...
template<typename Dtype>
void GPUMathBackend<Dtype>::rng_uniform(const int N, const Dtype a,
...
template<typename Dtype>
void GPUMathBackend<Dtype>::scale(const int N, const Dtype alpha,
