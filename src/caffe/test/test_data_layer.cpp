...
TYPED_TEST(DataLayerTest, TestCroppedReadCPUTrain) {
...
TYPED_TEST(DataLayerTest, TestCroppedReadGPUTrain) {
  Caffe::set_phase(Caffe::TRAIN);
  Caffe::set_mode(Caffe::GPU);
  const bool unique_pixels = true;  // all images the same; pixels different
  this->FillLevelDB(unique_pixels);
...
TYPED_TEST(DataLayerTest, TestCroppedReadCPUTest) {
...
TYPED_TEST(DataLayerTest, TestCroppedReadGPUTest) {
  Caffe::set_phase(Caffe::TEST);
  Caffe::set_mode(Caffe::GPU);
  const bool unique_pixels = true;  // all images the same; pixels different
  this->FillLevelDB(unique_pixels);
