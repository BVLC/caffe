...
namespace caffe {
  ...
  class SoftmaxWithInfogainLossLayerTest : public MultiDeviceTest<TypeParam> {
    typedef typename TypeParam::Dtype Dtype;

  protected:
    SoftmaxWithInfogainLossLayerTest()
    ...
    virtual ~SoftmaxWithInfogainLossLayerTest() {
  ...
  TYPED_TEST_CASE(SoftmaxWithInfogainLossLayerTest, TestDtypesAndDevices);

  TYPED_TEST(SoftmaxWithInfogainLossLayerTest, TestSoftmaxWithInfogainLoss) {
    typedef typename TypeParam::Dtype Dtype;
  ...
  lw->push_back(1);
  lw->push_back(1);*/
    SoftmaxWithInfogainLossLayer<Dtype> layer(layer_param);
  ...
  TYPED_TEST(SoftmaxWithInfogainLossLayerTest, TestGradient) {
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
    layer_param.mutable_infogain_loss_param()->set_axis(2);
    SoftmaxWithInfogainLossLayer<Dtype> layer(layer_param);
