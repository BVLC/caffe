...
class NeuronLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  ...
  void TestSetup(int num_images, int num_channels,
  ...
  void AbsValLayerTestForwardPerformance(int num_images, int num_channels,
                                         int im_width, int im_height) {
  ...
  void ReLULayerTestForwardPerformance(int num_images, int num_channels,
                                       int im_width, int im_height) {
    this->TestSetup(num_images, num_channels, im_width, im_height);
  ...
  void SigmoidLayerTestForwardPerformance(int num_images, int num_channels,
                                          int im_width, int im_height) {
    this->TestSetup(num_images, num_channels, im_width, im_height);
...
TYPED_TEST(NeuronLayerTest, TestForwardPerformance) {
  for ( int i = TEST_IMAGE_WIDTH_MIN; i <= TEST_IMAGE_WIDTH_MAX; i*=2 ) {
    this->AbsValLayerTestForwardPerformance(TEST_NUM_IMAGES,
                                            TEST_NUM_CHANNELS, i, i);
    this->ReLULayerTestForwardPerformance(TEST_NUM_IMAGES,
                                          TEST_NUM_CHANNELS, i, i);
    this->SigmoidLayerTestForwardPerformance(TEST_NUM_IMAGES,
                                             TEST_NUM_CHANNELS, i, i);
  }
}
