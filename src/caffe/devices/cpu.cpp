...
template<>
void CPUDevice<float>::abs(const int n, const float* a, float* y) {
  vsAbs(n, a, y);
}

template<>
void CPUDevice<double>::abs(const int n, const double* a, double* y) {
  vdAbs(n, a, y);
}
...
void CPUDevice<unsigned int>::axpby(const int N, const unsigned int alpha,
    const unsigned int* X, const unsigned int beta, unsigned int* Y) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<Dtype>::col2im(const Dtype* data_col, const int channels,
    ...
    Dtype* data_im) {
  this->set(height * width * channels, Dtype(0), data_im);
...
template<>
void CPUDevice<int>::exp(const int N, const int* a, int* y) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<int>::gemm(const CBLAS_TRANSPOSE TransA,
    const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
    const int alpha, const int* A, const int* B, const int beta, int* C) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<unsigned int>::gemm(const CBLAS_TRANSPOSE TransA,
    const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
    const unsigned int alpha, const unsigned int* A, const unsigned int* B,
...
void CPUDevice<int>::gemv(const CBLAS_TRANSPOSE TransA, const int M,
    const int N, const int alpha, const int* A, const int* x, const int beta,
    int* y) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<unsigned int>::gemv(const CBLAS_TRANSPOSE TransA, const int M,
    const int N, const unsigned int alpha, const unsigned int* A,
    const unsigned int* x, const unsigned int beta, unsigned int* y) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<unsigned int>::hamming_distance(const int N,
    const unsigned int* x, const unsigned int* y, int* out) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<unsigned int>::rng_gaussian(const int n, const unsigned int mu,
    const unsigned int sigma, unsigned int* r) {
  NOT_IMPLEMENTED;
}
...
void CPUDevice<unsigned int>::rng_uniform(const int n, const unsigned int a,
    const unsigned int b, unsigned int* r) {
  NOT_IMPLEMENTED;
}
...
template<>
void CPUDevice<int>::sqr(const int N, const int* a, int* y) {
  NOT_IMPLEMENTED;
}
...
template<>
void CPUDevice<float>::strided_dot(const int n, const float* x, const int incx,
    const float* y, const int incy, float* out) {
  *out = cblas_sdot(n, x, incx, y, incy);
}

template<>
void CPUDevice<double>::strided_dot(const int n, const double* x,
    const int incx, const double* y, const int incy, double* out) {
