...
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, GenerateProgram,
...
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Forward_gpu,
                                  (half_fp), (half_fp), (half_fp));
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Forward_gpu,
                                  (float), (float), (float));
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Forward_gpu,
...
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Backward_gpu,
                                  (half_fp), (half_fp), (half_fp));
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Backward_gpu,
                                  (float), (float), (float));
INSTANTIATE_CLASS_FUNC_3T_GUARDED(ReLULayer, Backward_gpu,
