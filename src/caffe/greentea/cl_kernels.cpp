...
"",    // NOLINT
"Dtype local_kernel_data = 0.;",    // NOLINT
"Dtype local_bias_data = 0.;",    // NOLINT
"if (sub_id < KERNEL_SIZE)",    // NOLINT
"local_kernel_data = kernel_dataPtrFloat[sub_id];",    // NOLINT
"if (sub_id == 0)",    // NOLINT
"local_bias_data = biases_base[biasIndex];",    // NOLINT
"",    // NOLINT
"// #define BLOCK_IN(n,i) sub_group_broadcast(kernel_data, (n))",    // NOLINT
"if(outputX < output_width && outputY < output_height)",    // NOLINT
"{",    // NOLINT
"Dtype sum = 0.;",    // NOLINT
"",    // NOLINT
...
"continue;",    // NOLINT
"}",    // NOLINT
"sum += image_dataPtrFloat[x * DILATION_X] * sub_group_broadcast(local_kernel_data, (x+y*KERNEL_W));",    // NOLINT
"}",    // NOLINT
"image_dataPtrFloat += input_width * DILATION_Y;",    // NOLINT
"}",    // NOLINT
"#if APPLY_BIAS",    // NOLINT
