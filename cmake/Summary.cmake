...
function(caffe_print_configuration_summary)
  ...
  caffe_status("  ENABLE_PROFILING  :   ${ENABLE_PROFILING}")
  caffe_status("")
  ...
  caffe_status("  USE_OPENCL        :   ${USE_OPENCL}")
  caffe_status("  USE_CLGEMM        :   ${USE_CLGEMM}")  
  caffe_status("  USE_OPENMP        :   ${USE_OPENMP}")
  caffe_status("  USE_TIMER         :   ${USE_TIMER}")
  caffe_status("")
  ...
  caffe_status("  OpenCL            : " OPENCL_FOUND THEN "Yes (ver. ${OPENCL_VERSION_STRING})" ELSE "No")
