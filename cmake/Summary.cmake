...
function(caffe_print_configuration_summary)
  ...
  caffe_status("  USE_OPTIX         :   ${USE_OPTIX}")
  caffe_status("")
  ...
  caffe_status("  GSL               : " HAVE_GSL THEN "Yes (ver. ${GSL_VERSION})" ELSE "No" )
  caffe_status("  OptiX             : " OPTIX_FOUND THEN "Yes (ver. ${OPTIX_VERSION})" ELSE "No" )
  caffe_status("  GLUT              : " GLUT_FOUND THEN "Yes" ELSE "No" )
  caffe_status("  GLEW              : " GLEW_FOUND THEN "Yes" ELSE "No" )
  caffe_status("  OpenGL            : " OPENGL_FOUND THEN "Yes" ELSE "No" )
  caffe_status("  tiff              : " HAVE_TIFF THEN "Yes (ver. ${TIFF_VERSION_STRING})" ELSE "No" )
  caffe_status("  fftw              : " HAVE_FFTW THEN "Yes" ELSE "No" )
  caffe_status("")
  if(HAVE_CUDA)
