...
if (USE_ISAAC)
  ...
  list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${ISAAC_INCLUDE_DIR})
...
if(NOT APPLE)
  ...
  elseif(BLAS STREQUAL "Open" OR BLAS STREQUAL "open")
    ...
    list(APPEND Caffe_DEFINITIONS PUBLIC -DUSE_OpenBLAS)
...
# ---[ FFmpeg_qsv
if(USE_FFMPEG_QSV)
  find_package(ffmpegQSV REQUIRED)
  list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${ffmpegQSV_INCLUDES})
  list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${ffmpegQSV_mfx_INCLUDES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_avcodec_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_avfilter_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_avformat_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_avutil_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_mfx_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_libva_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_libva-drm_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_dl_LIBRARIES})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${ffmpegQSV_rt_LIBRARIES})
  list(APPEND Caffe_DEFINITIONS PUBLIC -DUSE_FFMPEG_QSV)
  list(APPEND Caffe_DEFINITIONS PUBLIC -DMFX_DISPATCHER_EXPOSED_PREFIX)
endif()
