...
# ---[ Boost
find_package(Boost 1.46 REQUIRED COMPONENTS system thread filesystem date_time)
...
# GSL for weight histograms
find_package(GSL)
if (GSL_FOUND)
  set(HAVE_GSL TRUE)
  include_directories(SYSTEM ${GSL_INCLUDE_DIRS})
  list(APPEND Caffe_LINKER_LIBS ${GSL_LIBRARIES})
endif()
...
if (USE_OPTIX)
  ...
  include_directories(SYSTEM ${OPTIX_INCLUDE_DIR} ${OPENGL_INCLUDE_DIR} ${GLUT_INCLUDE_DIR} ${GLEW_INCLUDE_DIR})
  add_definitions(-DUSE_OPTIX)
endif()

# libtiff for reading pelican indexed tiffs
find_package(TIFF)
if (TIFF_FOUND)
  set(HAVE_TIFF TRUE)
  include_directories(SYSTEM ${TIFF_INCLUDE_DIRS})
  list(APPEND Caffe_LINKER_LIBS ${TIFF_LIBRARIES})
endif()
