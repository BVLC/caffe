...
template<typename T> bool clkernel_channel_max(
    const int num,
    const int channels,
    const int spatial_dim,
    const T* data,
    T* out);
template<typename T> bool clkernel_channel_subtract(
    const int num,
    const int channels,
    const int spatial_dim,
    T* data,
...
template<typename T> bool clkernel_channel_sum(
    const int num,
    const int channels,
    const int spatial_dim,
    const T* data,
    T* channel_sum);
template<typename T> bool clkernel_channel_div(
    const int num,
    const int channels,
    const int spatial_dim,
    T* data,
    const T* channel_sum);
template<typename T> bool clkernel_channel_dot(
    const int num,
    const int channels,
    const int spatial_dim,
    const T* data_1,
