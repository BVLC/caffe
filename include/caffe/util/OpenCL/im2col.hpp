...
namespace OpenCL {
  ...
  template<typename T> bool clim2col_gpu(const int n, const T* data_im, const size_t data_im_step, const int height, const int width, const int kernel_h, const int kernel_w, const int pad_h, const int pad_w, const int stride_h, const int stride_w, const int height_col, const int width_col, T* data_col, const size_t data_col_step);
	template<typename T> bool clim2col_group_gpu(const int num_kernels, const T* data_im, const int bottom_step, const int num_images, const int num_channels, const int height, const int width, const int kernel_h, const int kernel_w, const int pad_h, const int pad_w, const int stride_h, const int stride_w, const int height_col, const int width_col, T* data_col, const int top_step);
	template<typename T> bool clim2col_group_gpu(const T* data_im, const int* mask, const int num_images, const int num_channels, const int height, const int width, const int kernel_h, const int kernel_w, const int height_out, const int width_out, T* data_col);
