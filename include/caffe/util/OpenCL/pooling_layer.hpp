...
template<typename T> bool clMaxPoolBackward(
    const int nthreads,
    const T* top_diff,
    const int* mask,
    const T* top_mask,
    ...
    const int pad_w,
    T* bottom_diff);
template<typename T> bool clAvePoolBackward(
    const int nthreads,
    const T* top_diff,
    const int num,
    const int channels,
    ...
    const int pad_w,
    T* bottom_diff);
template<typename T> bool clStoPoolBackward(
    const int nthreads,
    const T* rand_idx,
    const T* top_diff,
    const int num,
...
template<typename T> bool clMaxPoolForward(
    ...
    int* mask,
    T* top_mask);
template<typename T> bool clAvePoolForward(
    const int nthreads,
    const T* botton_data,
    const int num,
    const int channels,
    ...
    int* mask,
    T* top_mask);
template<typename T> bool clStoPoolForwardTrain(
    const int nthreads,
    const T* bottom_data,
    const int num,
    const int channels,
    ...
    T* rand_idx,
    T* top_data);
template<typename T> bool clStoPoolForwardTest(
    const int nthreads,
    const T* bottom_data,
    const int num,
    const int channels,
