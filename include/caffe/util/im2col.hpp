...
void im2col_cpu(const Dtype* data_im, const int_tp channels, const int_tp height,
...
template<typename Dtype>
void col2im_cpu(const Dtype* data_col, const int_tp channels, const int_tp height,
