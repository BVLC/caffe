...
void greentea_im2col_gpu(viennacl::ocl::program &prog,
                         viennacl::ocl::context &ctx, const cl_mem data_im, const int data_im_off,
                         const int channels, const int height, const int width,
                         const int kernel_h, const int kernel_w,
                         const int pad_h, const int pad_w, const int stride_h,
                         const int stride_w, cl_mem data_col, const int data_col_off);

template<typename Dtype>
void greentea_col2im_gpu(viennacl::ocl::program &prog,
                         viennacl::ocl::context &ctx, const cl_mem data_col, const int data_col_off,
                         const int channels, const int height, const int width,
                         const int patch_h, const int patch_w, const int pad_h,
                         const int pad_w, const int stride_h,
                         const int stride_w, cl_mem data_im, const int data_im_off);
