 ...
 */
template <typename Dtype>
class ImageDataLayerMultiRegression : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit ImageDataLayerMultiRegression(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~ImageDataLayerMultiRegression();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
