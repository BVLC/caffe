...
namespace caffe {
  ...
  /**
   * @brief A generalization of SoftmaxIwthLossLayer that takes an
  ...
  class SoftmaxWithInfogainLossLayer : public LossLayer<Dtype> {
  public:
    explicit SoftmaxWithInfogainLossLayer(const LayerParameter& param)
    ...
    // SoftmaxWithInfogainLossLayer takes 2-3 bottom Blobs; if there are 3 the third should
    ...
    virtual inline const char* type() const { return "SoftmaxWithInfogainLoss"; }

  protected:
    /// @copydoc SoftmaxWithInfogainLossLayer
