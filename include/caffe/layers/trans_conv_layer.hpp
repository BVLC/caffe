#ifndef CAFFE_TRANS_CONV_LAYER_HPP_
#define CAFFE_TRANS_CONV_LAYER_HPP_
...
class TransformerConvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
  /**
   ...
   */
  explicit TransformerConvolutionLayer(const LayerParameter& param)
...
#endif  // CAFFE_TRANS_CONV_LAYER_HPP_
