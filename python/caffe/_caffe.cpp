...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  bp::class_<Net<Dtype>, shared_ptr<Net<Dtype> >, boost::noncopyable >("Net",
    ...
    .def("save", &Net_Save);
  if (boost::python::converter::registry::query(boost::python::type_id <shared_ptr<Net<Dtype> > >()) == NULL)
  ...
  bp::class_<Blob<Dtype>, shared_ptr<Blob<Dtype> >, boost::noncopyable>(
    ...
    .add_property("diff",     bp::make_function(&Blob<Dtype>::mutable_cpu_diff,
          NdarrayCallPolicies()));
  if (boost::python::converter::registry::query(boost::python::type_id <shared_ptr<Blob<Dtype> > >()) == NULL)
  ...
  if (boost::python::converter::registry::query(boost::python::type_id <shared_ptr<Solver<Dtype> > >()) == NULL)
