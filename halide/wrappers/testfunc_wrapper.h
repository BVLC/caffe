...
class TestFuncWrapper : public Layer<Dtype> {
public:
  explicit TestFuncWrapper(const LayerParameter& param)
      : Layer<Dtype>(param),
...
template class TestFuncWrapper<float>;
template class TestFuncWrapper<double>;
