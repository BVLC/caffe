...
TESTS_EXCLUDED="*GPU*:*Performance*:*Validation*:*SoftmaxWithLossLayerTest*:*SoftmaxLayerTest*:*NeuronLayerTest/*.TestPReLUInPlace:*SGDSolverTest/*.TestLeastSquaresUpdate:*NetTest/*.TestLossWeight*"
...
#	$(TEST_ALL_BIN) $(TEST_GPUID) --gtest_shuffle $(TEST_FILTER)
	$(TEST_ALL_BIN) $(TEST_GPUID) $(TEST_FILTER)
