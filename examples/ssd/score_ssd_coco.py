...
save_dir = "examples/ssd/VGGNet/coco/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "examples/ssd/VGGNet/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/coco/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/mscoco/results/{}_score/".format(datapath, job_name)
...
mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=mbox_source_layers,
        ...
        aspect_ratios=aspect_ratios, steps=steps, normalizations=normalizations,
        num_classes=num_classes, share_location=share_location, flip=flip, clip=clip,
        prior_variance=prior_variance, kernel_size=3, pad=1, lr_mult=lr_multi, engine=3)
