...
Follow instructions for [installing Caffe](/docs/installation.md) and run `scripts/download_model_binary.py models/bvlc_reference_caffenet` from caffe root directory.
